  ...
  <div class="col-2">
    ...
    <div class="list-group">
      ...
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
          ...
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=manage_gym" class="text-light">Manage GYM</a></div>
        </div>
      ...
      <div id="collapseThree" class="collapse" data-parent="#accordion">
        ...
        <div class="list-group-item" style="background-color: #303030;">
          <a href="home.php?info=manage_payment" class="text-light">MANAGE PAYMENT AREA</a>
        </div>
      ...
      <div id="collapsefive" class="collapse" data-parent="#accordion">
          ...
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=manage_member" class="text-light">MANAGE MEMBER</a></div>
        </div>
      ...
      <div id="collapsesix" class="collapse" data-parent="#accordion">
          ...
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=manage_trainer" class="text-light">MANAGE TRAINER</a></div>
        </div>
    </div>
</div>
